...
let Account = class Account extends MyBaseEntity_1.MyBaseEntity {
};
__decorate([
...
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsEnum)(role_constant_1.AccountRole),
    (0, typeorm_1.Column)({ type: "enum", enum: role_constant_1.AccountRole, nullable: false }),
    __metadata("design:type", String)
