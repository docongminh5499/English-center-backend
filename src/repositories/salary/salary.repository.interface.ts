...
export default interface SalaryRepository {
  ...
  findSalaryByBranch: (branchId: number, pageable: Pageable, fromDate?: Date, toDate?: Date) => Promise<Salary[]>;

  countSalaryByBranch: (branchId: number, fromDate?: Date, toDate?: Date) => Promise<number>;
}